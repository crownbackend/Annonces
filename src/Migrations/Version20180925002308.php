 ...
 */
final class Version20180925002308 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, conversations_id INT NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_DB021E96A76ED395 (user_id), INDEX IDX_DB021E96FE142757 (conversations_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
