 ...
 */
final class Version20180913181308 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advertisement CHANGE slug slug VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advertisement CHANGE slug slug VARCHAR(128) NOT NULL COLLATE utf8mb4_unicode_ci');
